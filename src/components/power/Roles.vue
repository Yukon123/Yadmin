<template>
  <div class="roles">
    ...
    <el-card class="box-card">
      ...
      <el-dialog title="分配权限" v-model="roleDialogVisible" width="40%">
        <el-tree
          :data="rightList"
          :props="treeProps"
          show-checkbox
      ...
      <el-dialog title="添加角色" v-model="addDialogVisible" width="40%" @close="addDialogClose">
      ...
      <el-dialog title="编辑角色" v-model="editorDialogVisible" width="40%" @close="editDialogClose">
